...
let resp_no_response =
  { number = ('4'::('0'::('1'::[]))); text =
    ('n'::('o'::(' '::('r'::('e'::('s'::('p'::('o'::('n'::('s'::('e'::(';'::(' '::('r'::('e'::('t'::('r'::('y'::[])))))))))))))))))) }

(** val resp_invalid_format : response **)

let resp_invalid_format =
  { number = ('5'::('0'::('1'::[]))); text =
...
let resp_accepted =
  { number = ('2'::('0'::('1'::[]))); text =
    ('a'::('c'::('c'::('e'::('p'::('t'::('e'::('d'::(':'::(' '::('0'::(' '::('0'::(' '::('0'::[]))))))))))))))) }

(** val resp_accepted_expiring : response **)

let resp_accepted_expiring =
  { number = ('2'::('0'::('2'::[]))); text =
    ('a'::('c'::('c'::('e'::('p'::('t'::('e'::('d'::(','::(' '::('p'::('a'::('s'::('s'::('w'::('o'::('r'::('d'::(' '::('i'::('s'::(' '::('e'::('x'::('p'::('i'::('r'::('i'::('n'::('g'::(':'::(' '::('0'::(' '::('0'::(' '::('0'::[]))))))))))))))))))))))))))))))))))))) }

(** val resp_wrong_password : response **)

let resp_wrong_password =
  { number = ('5'::('0'::('3'::[]))); text =
    ('a'::('c'::('c'::('e'::('s'::('s'::(' '::('d'::('e'::('n'::('i'::('e'::('d'::(','::(' '::('w'::('r'::('o'::('n'::('g'::(' '::('p'::('a'::('s'::('s'::('w'::('o'::('r'::('d'::[]))))))))))))))))))))))))))))) }

(** val resp_access_denied : response **)

let resp_access_denied =
  { number = ('5'::('0'::('2'::[]))); text =
    ('a'::('c'::('c'::('e'::('s'::('s'::(' '::('d'::('e'::('n'::('i'::('e'::('d'::[]))))))))))))) }

(** val resp_no_connection : response **)

let resp_no_connection =
  { number = ('5'::('0'::('4'::[]))); text =
    ('a'::('c'::('c'::('e'::('s'::('s'::(' '::('d'::('e'::('n'::('i'::('e'::('d'::(','::(' '::('n'::('o'::(' '::('e'::('x'::('i'::('s'::('t'::('i'::('n'::('g'::(' '::('c'::('o'::('n'::('n'::('e'::('c'::('t'::('i'::('o'::('n'::[]))))))))))))))))))))))))))))))))))))) }

(** val resp_not_admin : response **)

let resp_not_admin =
  { number = ('5'::('0'::('5'::[]))); text =
    ('a'::('c'::('c'::('e'::('s'::('s'::(' '::('d'::('e'::('n'::('i'::('e'::('d'::(','::(' '::('y'::('o'::('u'::(' '::('a'::('r'::('e'::(' '::('n'::('o'::('t'::(' '::('a'::('d'::('m'::('i'::('n'::('!'::[]))))))))))))))))))))))))))))))))) }

(** val resp_slip_mode : response **)

let resp_slip_mode =
  { number = ('5'::('0'::('6'::[]))); text =
    ('a'::('c'::('c'::('e'::('s'::('s'::(' '::('d'::('e'::('n'::('i'::('e'::('d'::(','::(' '::('u'::('s'::('e'::('r'::(' '::('i'::('s'::(' '::('a'::('l'::('r'::('e'::('a'::('d'::('y'::(' '::('i'::('n'::(' '::('s'::('l'::('i'::('p'::(' '::('m'::('o'::('d'::('e'::[]))))))))))))))))))))))))))))))))))))))))))) }

(** val resp_no_slip_connection : response **)

let resp_no_slip_connection =
  { number = ('5'::('0'::('4'::[]))); text =
    ('a'::('c'::('c'::('e'::('s'::('s'::(' '::('d'::('e'::('n'::('i'::('e'::('d'::(','::(' '::('n'::('o'::(' '::('e'::('x'::('i'::('s'::('t'::('i'::('n'::('g'::(' '::('s'::('l'::('i'::('p'::(' '::('c'::('o'::('n'::('n'::('e'::('c'::('t'::('i'::('o'::('n'::[])))))))))))))))))))))))))))))))))))))))))) }
